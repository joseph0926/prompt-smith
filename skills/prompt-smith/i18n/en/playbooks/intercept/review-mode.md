...
```
User: /ps:r Summarize the latest news using web search
Assistant: [WebSearch call] I'll search for the latest news...
```

Problem: Interpreted the phrase "web search" as a command to call WebSearch tool.
...
### Original Prompt
> Summarize the latest news using web search
