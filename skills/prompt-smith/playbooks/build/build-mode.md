...
| 복잡도 | 특성 | 권장 항목 |
|--------|------|----------|
| 단순 | 단일 스텝, 명확한 입출력 | 기본 5항목 (ROLE~FORMAT) |
| 중간 | 2-3 스텝, 조건부 로직 | 기본 5항목 + 상세 지시 |
| 복잡 | 4+ 스텝, 도구 사용, 상태 관리 | 7-Point 전체 (확장 항목 포함) |
...
### 목적
7-Point Quality Check의 각 요소를 설계합니다.
...
### 6. STATE_TRACKING (상태 관리) - 해당 시
- 상태 파일: [형식]
- 체크포인트: [시점]
- 재개: [방법]

### 7. TOOL_USAGE (도구 사용) - 해당 시
- 도구: [목록]
- 전략: [병렬/순차]
- 에러: [처리 방법]
```
...
### 목적
7-Point Quality Check로 초안을 검증합니다.
