#!/usr/bin/env node
/**
 * PromptShield Evaluation Runner
 *
...
*Generated by PromptShield Evaluation Runner v${VERSION}*
`;
...
function showHelp() {
  console.log(`
PromptShield Evaluation Runner v${VERSION}
...
async function main() {
  ...
  if (options.validateOnly) {
    console.log(`PromptShield Evaluation Runner v${VERSION}`);
